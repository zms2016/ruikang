	...
	<div class="row" style="margin:5px">
		<div class="col-md-10  ">
			...
			<div class="panel panel-default">
				<div class="panel-heading">一级菜单信息录入</div>
					...
					<form class="form-horizontal"       id="webForm"   >
					 ...
					 <div class="form-group">
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="icopath"  name="icopath"   value="components/menu01/images/left/custom.png">
							</div>
						</div>
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="icopathopen"  name="icopathopen"  value="components/menu01/images/left/custom.png">
							</div>
						</div>
...
$(function(){ 
    var options = {  
    	url:   "manager/addSuperMenuAction.html"  ,
    	type: "post"  ,
	     ...
	     if (responseText.msg=="insertOK")
	    	 {
	    		...
	    		warn("新增成功！","icopath",100,0);
	    	 
	    	 }
	     else{
	    		warn("新增失败！","icopath",100,0);
