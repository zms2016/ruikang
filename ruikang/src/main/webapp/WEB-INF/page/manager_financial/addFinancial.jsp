...
<body style="margin:20px">
	...
	<form  id="contentForm" name="contentForm"   method="post"    action="manager/addFinancialAction.html"     >
             ...
             <div class="form-group form-inline">
                ...
                <div class="form-group form-inline">
                 <label for="apr">  <strong style="font-size:1.2em"  >年化收益： </strong></label>
                   <input type="text"  class="form-control"   id="apr"  name="apr"  style="width:70%" >
             </div>
             
                <div class="form-group form-inline">
                 <label for="longtime">  <strong style="font-size:1.2em"  >投资期限： </strong></label>
                   <input type="text"  class="form-control"   id="longtime"  name="longtime"  style="width:70%" >
             </div>
             
                <div class="form-group form-inline">
                 <label for="backtype">  <strong style="font-size:1.2em"  >还款方式： </strong></label>
                   <input type="text"  class="form-control"   id="backtype"  name="backtype"  style="width:70%" >
             </div>
		  ...
		  <a href="javascript:void(0)"  class="btn btn-primary" style="margin-top:20px"  id="subBtn"> 提交内容</a>  
 ...
 <script>
  ...
  $("#subBtn").click(function(){
	  ...
	  $.ajax({
			type : 'POST',
			url : '${pageContext.request.contextPath}/manager/addFinancialAction.html',
