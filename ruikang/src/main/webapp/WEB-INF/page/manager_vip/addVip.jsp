	...
	<div class="row" style="margin:5px">
		<div class="col-md-10  ">
			...
			<div class="panel panel-default">
				<div class="panel-heading">理财客户信息录入</div>
				<div class="panel-body">
					...
					<form class="form-horizontal"       id="webForm"   >
						<div class="form-group" style="margin-top:10px">
							...
							<div class="col-sm-6">
								<input type="edit" class="form-control" id="name"  name="name"  placeholder="必填" maxlength="20" >
							</div>
						</div>
					 ...
					 <div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="mobilenum"  name="mobilenum" onkeyup="this.value=this.value.replace(/\D/g,'')"  maxlength="11"  size="14">
							</div>
						</div>
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="card"  name="card" maxlength="18"  size="18" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')">
							</div>
						</div>
                         	...
                         	<!--   <div class="form-group">
							  ...
							  <div class="col-sm-6">
							    <label class="radio-inline">
									...
									<label class="radio-inline">
									  <input type="radio" name="level" id="level" value="3"> 部门经理管理
									</label>
                         ...
                         <div class="form-group">
							                       ...
							                       <c:forEach var="item" items="${users}">
							                                   <c:choose>
							                                      <c:when test="${item.id==userId }">
							                                           <option value=${item.id}  selected="selected">${item.realname}</option>
							                                      </c:when>
							                                      <c:otherwise>
							...
							<div class="col-sm-6">
								<input type="edit" class="form-control" id="bankname"  name="bankname" maxlength="40">
							</div>
						</div>
							...
							<div class="col-sm-6">
								<input type="edit" class="form-control" id="banknum"  name="banknum"  maxlength="22"   onkeyup="this.value=this.value.replace(/\D/g,'')" >
							</div>
						</div>
							...
							<div class="col-sm-6">
								<input type="edit" class="form-control" id="address"  name="address" maxlength="50">
							</div>
						</div>
