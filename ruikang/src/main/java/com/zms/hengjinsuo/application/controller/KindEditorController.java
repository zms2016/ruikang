...
public class KindEditorController {
    ...
    public void fileUpload(HttpServletRequest request, HttpServletResponse response)
       ...
       // ServletContext application = request.getSession().getServletContext();
        ...
        //String savePath = application.getRealPath("/") + "kinderupload/";
        // 文件保存目录URL 主要返回给 编辑器用
       // String saveUrl = request.getContextPath() + "/kinderupload/";
        
         //由于上面2个是在项目
         String savePath=Constants.KINDERUPLOAD_PATH;
         
      //   String saveUrl="/kinderupload/";
         String saveUrl=Constants.KINDER_URL;
       
       //  savePath:D:\tomcat-7.0.63\webapps\hjs\kinderupload/saveUrl:/hjs/kinderupload/
    ...
    public void fileManager(HttpServletRequest request, HttpServletResponse response)
        ...
        String rootPath = application.getRealPath("/") + "kinderupload/";
        // 根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/upload/
        String rootUrl = request.getContextPath() + "/kinderupload/";
        // 图片扩展名
